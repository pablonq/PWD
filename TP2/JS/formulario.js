...
const validarCampo = (expresion, input, campo) => {
    if (expresion.test(input.value)){
        ...
        document.querySelector(`#grupo_${campo} i`).classList.remove("bi bi-patch-check-fill");
        document.querySelector(`#grupo_${campo} i`).classList.add("bi bi-patch-check-fill");
...
// --------- VALIDACION PASSWORD Y USUARIO ---------------
const validarPassword2 = () => {
    let inputPassword = document.getElementById("password");
    let usuario = document.getElementById("usuario");

    if (inputPassword.value == usuario.value) {
        ...
        document.querySelector(`#grupo_usuario i`).classList.add("bi bi-patch-check-fill");
        document.querySelector(`#grupo_usuario i`).classList.remove("bi bi-patch-check-fill");
